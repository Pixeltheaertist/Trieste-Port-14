...
ent-VendingMachineDiscount = Дешевый Дэн
    .desc = Торговый автомат с закусками из печально известной франшизы "Дешевый Дэн".
...
ent-VendingMachineSnackBlue = Шоколадная корпорация "Гетмор"
    .suffix = Синий
    .desc = { ent-VendingMachineSnack.desc }
ent-VendingMachineSnackOrange = Шоколадная корпорация "Гетмор"
    .suffix = Оранжевый
    .desc = { ent-VendingMachineSnack.desc }
ent-VendingMachineSnackGreen = Шоколадная корпорация "Гетмор"
    .suffix = Зелёный
    .desc = { ent-VendingMachineSnack.desc }
ent-VendingMachineSnackTeal = Шоколадная корпорация "Гетмор"
    .suffix = Сине-зелёный
    .desc = { ent-VendingMachineSnack.desc }
ent-VendingMachineSnack = Шоколадная корпорация "Гетмор"
...
ent-VendingMachineChang = Мр. Чанг
...
ent-VendingMachineDonut = Пончики Монкина
...
ent-VendingMachineWallMedicalMaint = НаноМед
    .desc = Это настенный диспенсер для медицинского оборудования. Только натуральные химикаты!
ent-VendingMachineChefvendMaint = ШефШкаф
    .desc = Поставщик ингредиентов для всех ваших кулинарных нужд.
ent-VendingMachineChemicalsMaint = ХимкоМат
    .suffix = Открыт
    .desc = Вероятно, не кофемашина.
ent-VendingMachineDinnerwareMaint = Автомат с посудой для шеф-повара из Пластилина
