...
ent-ClothingOuterHardsuitAbyssal = Абиссальный костюм G.I.L.L.Y
    .desc = Скафандр со встроенным жестким каркасом, который механически выдвигает пользователя вперед, защищая его от смертельных глубин. Чрезвычайно сложен в эксплуатации.
