...
ent-ClothingHeadHelmetAbyssal = Абиссальный шлем G.I.L.L.Y
    .desc = Тяжелый шлем, рассчитанный на то, чтобы выдерживать неописуемое давление. В нем используется встроенная камера для наблюдения за пользователем.
