...
ent-TP14WeaponEnergyCarbine = энергетический карабин NT-331
    .desc = Усовершенствованный карабин, используемый оперативниками NT. В нем есть гнездо для энергетической батареи.
ent-TP14WeaponRifleEnergyRepeater = старый ретранслятор
    .desc = Древний энергетический ретранслятор, которым пользовались старые космические ковбои. По современным меркам, его мощности явно недостаточно. Для подзарядки аккумулятора используется рукоятка.
ent-TP14WeaponNtBlaster = мощный бластер BM-138
    .desc = Нанотразеновый бластерный пистолет, используемый оперативниками и агентами. В нем имеется гнездо для энергетической батареи.
ent-TP14WeaponBlaster = пистолет распыления частиц TX-220
    .desc = Надежное энергетическое оружие, найденное в приграничных секторах галактики.
