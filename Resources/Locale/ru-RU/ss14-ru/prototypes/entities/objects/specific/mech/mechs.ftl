...
ent-TP14MechStepfather = Толстый папаша
    .desc = Надежная глубоководная горнодобывающая установка, предназначенная для работы в паре с пилотом. Встроенный искусственный интеллект управляет основным зажимом, в то время как пилот управляет модулями.
