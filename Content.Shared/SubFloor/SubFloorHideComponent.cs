...
public sealed partial class SubFloorHideComponent : Component
{
    ...
    /// <summary>
    ///     Controls the draw order of this entity relative to other subfloor
    ///     entities on the same tile. Lower values are drawn below higher values.
    /// </summary>
    [DataField]
    public SubfloorLayers SubfloorLayer { get; set; } = SubfloorLayers.Misc;
}
