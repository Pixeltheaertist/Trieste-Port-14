...
public sealed partial class NewIdCardConsoleWindow : DefaultWindow
{
    [Dependency] private IConfigurationManager _cfgManager = default!;
    [Dependency] private IPrototypeManager _prototypeManager = default!;
    [Dependency] private IEntityManager _entManager = default!;

    private readonly NewIdCardConsoleBui _owner;
    ...
    public NewIdCardConsoleWindow(NewIdCardConsoleBui owner,
        ...
        List<ProtoId<AccessLevelPrototype>> accessLevels)
    {
        ...
        if (DepartmentList.Count > 0)
            DepartmentList[0].Selected = true;

        foreach (var (_, button) in AccessButtons.ButtonsList)
        {
