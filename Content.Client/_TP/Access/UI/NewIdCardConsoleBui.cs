...
{
    public sealed partial class NewIdCardConsoleBui : BoundUserInterface
    {
        [Dependency] private IPrototypeManager _prototypeManager = default!;
        private readonly SharedIdCardConsoleSystem _idCardConsoleSystem = default!;

        private NewIdCardConsoleWindow? _window;

        public NewIdCardConsoleBui(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        ...
        protected override void Open()
        {
            ...
            _window = new NewIdCardConsoleWindow(this, _prototypeManager, accessLevels)
            {
