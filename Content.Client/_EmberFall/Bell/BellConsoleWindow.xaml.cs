...
public sealed partial class BellConsoleWindow : FancyWindow
{
    ...
    public BellConsoleWindow(EntityUid owner)
    {
        ...
        if (!_entMan.TryGetComponent<Shared._EmberFall.Bell.Components.BellConsoleComponent>(owner, out var comp))
            return;
    ...
    private void UpdateDestinations(List<Shared._EmberFall.Bell.Components.BellDestination> destinations)
    {
        Destinations.Clear();
